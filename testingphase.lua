...
local spawnBtn = createButton(petTabFrame, "SPAWN", 0.44, 0.44)
local duplicateBtn = createButton(petTabFrame, "DUPE", 0.44, 0.44)
duplicateBtn.Position = UDim2.new(0.51, 0, 0.44, 0)
