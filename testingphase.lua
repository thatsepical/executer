...
mainFrame.Size = UDim2.new(0, 250*uiScale, 0, 180*uiScale) -- Changed from 220 to 180
mainFrame.Position = UDim2.new(0.5, -125*uiScale, 0.5, -90*uiScale) -- Adjusted position accordingly
...
local amountBox = createTextBox(seedTabFrame, "Amount", UDim2.new(0.05, 0, 0.20, 0))
local eggNameBox = createTextBox(eggTabFrame, "Egg Name", UDim2.new(0.05, 0, 0.05, 0))
local spinBox = createTextBox(eggTabFrame, "Plant to Spin", UDim2.new(0.05, 0, 0.20, 0))
